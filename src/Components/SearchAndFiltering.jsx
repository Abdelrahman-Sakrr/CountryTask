    ...
    <div className="px-5 flex items-center gap-10 justify-between">
      <input
        ...
        onChange={(e) => {
          ...
          onCountryChange(e.target.value.trim());
        }}
      ...
      <select
        ...
        className="mb-10  dark:bg-primaryBlue dark:text-white bg-gray-200 text-black px-5 py-2 rounded-md shadow-lg outline-none cursor-pointer"
      >
        {regions.map((region) => (
          <option
            key={region.value}
